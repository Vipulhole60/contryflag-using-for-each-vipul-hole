...
let contryinfo = document.getElementById("contryinfo");
let result = ' ';
countries.forEach(function (contry) {
  result +=
    ` <div class="col-lg-3 col-md-6 col-xs-12">
       <div class="card mb-4 mt-2">
              <figure class="cr-image">
                  <img src="${contry.flag}" alt="${contry.name}">
                  <figcaption>
                        <div class="heading text-warning">
                          <h4>
                          ${contry.name}
                          </h4>
                        </div>
                        <div class="details">
                          <p><strong>Capital : </strong>${contry.capital}</p>
                          <p><strong>Language : </strong>${contry.languages}</p>
                          <p><strong>Population :</strong> ${contry.population}</p>                       
                        </div>
                  </figcaption>
              </figure>
       </div>
